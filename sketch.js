...
function preload() {
  mySound1 = loadSound('assets/3 27 You Re Dead.mp3');
  mySound2 = loadSound('assets/super-mario-bros-pipe.mp3');
  mySound3 = loadSound('assets/GoalHorn.mp3');
  mySound = loadSound('assets/1 01 Main Theme Overworld.mp3');
